...
**[BightWatch](https://nzbvtzu9v7rxdjv5jf4yng.streamlit.app/)** *(DataHacks 2026)* — Larval-stress risk-triage engine for the Southern California Bight. Engineered a tolerant compound-join ETL pipeline across 72 years of CalCOFI observations with real-time OISST SST and BEUTI upwelling bridges; trained supervised ML models to rank 13 monitoring zones by larval-stress risk. Also built a Gemini-powered chat interface for natural-language zone Q&A and cross-zone comparisons, using function calling to fetch live risk scores mid-conversation with guardrails ensuring numeric claims trace to source data.
